...
impl From<wisp_db::types::ChatError> for ConversationEngineError {
    fn from(value: wisp_db::types::ChatError) -> Self {
        Self::Chat(value)
    }
}
    ...
    pub fn continue_from_leaf(
        ...
        for round in 0..=self.config.max_tool_rounds {
            ...
            self.chat
                ...
                .map_err(wisp_db::types::ChatError::from)?;
...
mod tests {
    ...
    use super::*;
    use crate::types::{ConversationToolContent, ConversationToolResult};
